...
public class ClassUtils {
	...
	private static final String[]		CLASS_PATH_ARRAYS;

	static {
		CLASS_PATH_ARRAYS = System.getProperty("java.class.path")
									.split(System.getProperty("path.separator"));
		System.out.println("---------- START java.class.path ----------");
		for (String classPath : CLASS_PATH_ARRAYS) {
			System.out.println("-- " + classPath);
		}
		System.out.println("---------- E N D java.class.path ----------");
	}
	...
	public static List<Class<?>> scanPackage(	String packageName,
		...
		for (String classPath : getClassPathArray()) {
			...
			fillClasses(new File(classPath),
						getWellFormedPackageName(packageName),
						classFilter,
						classes);
		}
		return classes;
	 ...
	 *            List 集合
	 */
	private static void fillClasses(File file,
									String packageName,
									ClassFilter classFilter,
									List<Class<?>> classes) {
		if (isDirectory(file)) {
	...
	private static void processClassFile(	File file,
											...
											ClassFilter classFilter,
											List<Class<?>> classes) {
		final String filePathWithDot = file.getAbsolutePath()
